...
insert into restaurant (name, location, music, accomodation, smoking_area, nonsmoking_area, alcoholic_drinks, nonalcoholic_drinks, pet_friendly, rate, kid_friendly, high_demand) values
                        ('Corso', 2, 'relaxing', 'tradicionalno', true, false, true, true, true, 4, true, false);
insert into restaurant (name, location, music, accomodation,  smoking_area, nonsmoking_area, alcoholic_drinks, nonalcoholic_drinks, pet_friendly, rate, kid_friendly, high_demand) values
                        ('Atrijum', 10, 'loud', 'udobno', true, false, true, true, false, 2, true, false);
insert into restaurant (name, location, music, accomodation,  smoking_area, nonsmoking_area, alcoholic_drinks, nonalcoholic_drinks, pet_friendly, rate, kid_friendly, high_demand) values
                        ('Loft', 0.6, 'loud', 'tradicionalno', false, false, false, true, false, 3.5, false, false);
insert into restaurant (name, location, music, accomodation,  smoking_area, nonsmoking_area, alcoholic_drinks, nonalcoholic_drinks, pet_friendly, rate, kid_friendly, high_demand) values
                        ('Masa', 7, 'loud', 'tradicionalno', true, false, true, true, false, 3.5, false, false);
insert into restaurant (name, location, music, accomodation,  smoking_area, nonsmoking_area, alcoholic_drinks, nonalcoholic_drinks, pet_friendly, rate, kid_friendly, high_demand) values
